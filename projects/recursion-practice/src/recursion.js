...
var factorial = function(n) {
      ...
      if (n === 0){
        ...
        // recursion
        // multiply n and call back  function minus 1
...
var exponent = function(base, exp) {
  ...
  if (exp === 0) 
  return 1;
  let rec = base * exponent(base, exp-1);
  return !f ? rec : 1/rec;
...
var letterTally = function(str, obj={}) {
  ...
  if (obj.hasOwnProperty(str[0]) === true) {
    // base:
    obj[str[0]] + obj[str[0]]++
  }
  // recursion
...
var numToText = function(str, output = []) {
  ...
  if (str.length === 0) {
   ...
   if (str[0].match(/\d/g)) {
   output.push(numbers[parseInt(str[0] - 1)])
  }
  else {
  output.push(str[0])
  }
